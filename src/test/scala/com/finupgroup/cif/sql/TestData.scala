...
object TestData {
  ...
  val row7: Row = Map("age" -> 30, "sex" -> "female", "birthDay" -> toDate(1989, 4, 2))
  val wrongRow: Row = Map("name" -> "doudou", "age" -> 3)
  val user1: Table = List(row1, row2, row3, row4, row5, row6, row7,wrongRow)
